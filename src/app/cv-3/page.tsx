    ...
    <article className="max-w-[1400px] mx-auto py-6">
      ...
      <div className="grid grid-cols-12 gap-4 mb-5">
        <section className="col-span-12 md:col-span-4 xl:col-span-3">
          <div className="bg-[#fbede0] rounded-tl-3xl p-8 mb-5">
          ...
          <div className="bg-[#fbebeb]  rounded-tr-3xl p-8 mb-5">
          ...
          <div className="bg-[#f8f3ef]  rounded-tl-3xl p-8">
            <h3 className="relative text-2xl font-semibold py-4 tracking-[4px] before:absolute before:w-10 before:h-[2px] before:bg-gray-900 before:left-0 before:bottom-0 mb-6">
              Idiomas
            </h3>
            <div className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-lg">Inglés</h4>
              <div className="flex items-center gap-1">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
        ...
        <section className="col-span-12 md:col-span-8 xl:col-span-9">
          <div className="bg-[#f8f3ef] rounded-tl-3xl rounded-br-3xl p-8 pb-9 mb-5">
            <h3 className="relative text-2xl font-semibold py-4 tracking-[4px] before:absolute before:w-10 before:h-[2px] before:bg-gray-900 before:left-0 before:bottom-0 mb-6">
              Experiencia
            </h3>
          ...
          <div className="bg-[#fbede0] rounded-tl-3xl rounded-br-3xl p-8 pb-[2.5rem]">
            <h3 className="relative text-2xl font-semibold py-4 tracking-[4px] before:absolute before:w-10 before:h-[2px] before:bg-gray-900 before:left-0 before:bottom-0 mb-6">
              Educación
            </h3>
      ...
      <div className="bg-[#fbebeb] rounded-tr-3xl rounded-bl-3xl p-8">
        <h3 className="relative text-2xl font-semibold py-4 tracking-[4px] before:absolute before:w-10 before:h-[2px] before:bg-gray-900 before:left-0 before:bottom-0 mb-6">
          Habilidades
        </h3>
